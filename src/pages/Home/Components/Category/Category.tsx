...
export default function Category() {
  return (
    <div className='grid md:grid-cols-6 md:grid-rows-1 grid-cols-2 grid-rows-3 gap-2 rounded-md py-2 bg-white'>
      <button className='flex flex-col justify-start items-center gap-2 rounded-md p-2 bg-grayPrimary transition-colors duration-300 hover:bg-yellowPrimary/10'>
